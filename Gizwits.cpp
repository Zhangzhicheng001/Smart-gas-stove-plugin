...
void Gizwits::read(EVENT_TYPE_T eventType, bool* value)
{
	...
	{
	      case EVENT_submit:
	        *value = currentDataPoint.valuesubmit;
	        break;
	      case EVENT_ignition:
	        *value = currentDataPoint.valueignition;
	        break;
	      case EVENT_mode_Slow_fire_old_soup:
	        *value = currentDataPoint.valuemode_Slow_fire_old_soup;
	        break;
	      case EVENT_mode_Firewood:
	        *value = currentDataPoint.valuemode_Firewood;
	        break;
	      case EVENT_mode_Steamed_bag:
	        *value = currentDataPoint.valuemode_Steamed_bag;
	        break;
		default:
			break;
	}
...
void Gizwits::read(EVENT_TYPE_T eventType, uint32_t* value)
{
	switch(eventType)
	{
	      case EVENT_dianji_one:
	        *value = currentDataPoint.valuedianji_one;
	        break;
	      case EVENT_set_the_time:
	        *value = currentDataPoint.valueset_the_time;
	        break;
		default:
			break;
	}
...
bool Gizwits::hasBeenSet(EVENT_TYPE_T eventType)
{
	...
	{
			case EVENT_submit:
				flag = 	attrFlags.flagsubmit;
				attrFlags.flagsubmit = 0;
				break;
			case EVENT_ignition:
				flag = 	attrFlags.flagignition;
				attrFlags.flagignition = 0;
				break;
			case EVENT_mode_Slow_fire_old_soup:
				flag = 	attrFlags.flagmode_Slow_fire_old_soup;
				attrFlags.flagmode_Slow_fire_old_soup = 0;
				break;
			case EVENT_mode_Firewood:
				flag = 	attrFlags.flagmode_Firewood;
				attrFlags.flagmode_Firewood = 0;
				break;
			case EVENT_mode_Steamed_bag:
				flag = 	attrFlags.flagmode_Steamed_bag;
				attrFlags.flagmode_Steamed_bag = 0;
				break;
			case EVENT_dianji_one:
				flag = 	attrFlags.flagdianji_one;
				attrFlags.flagdianji_one = 0;
				break;
			case EVENT_set_the_time:
				flag = 	attrFlags.flagset_the_time;
				attrFlags.flagset_the_time = 0;
				break;
		default:
			break;
	}
...
void Gizwits::write(VALUE_TYPE_T valueType, uint32_t value)
{
	switch(valueType)
	{
		...
		break;
		case VALUE_time_left:
			currentDataPoint.valuetime_left = value;
		break;
		case VALUE_yanwu:
			currentDataPoint.valueyanwu = value;
		break;
		case VALUE_huoyan:
			currentDataPoint.valuehuoyan = value;
		break;
		default:
			break;
	}
