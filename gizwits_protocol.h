...
* @{
*/
#define PRODUCT_KEY "b828b4aa6180445db64eaa2397e4d290"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "297a942860b64e38961ecf79d5d5bf93"
...
* @{
*/
#define submit_BYTEOFFSET                    0
#define submit_BITOFFSET                     0
#define submit_LEN                           1
#define ignition_BYTEOFFSET                    0
#define ignition_BITOFFSET                     1
#define ignition_LEN                           1
#define mode_Slow_fire_old_soup_BYTEOFFSET                    0
#define mode_Slow_fire_old_soup_BITOFFSET                     2
#define mode_Slow_fire_old_soup_LEN                           1
#define mode_Firewood_BYTEOFFSET                    0
#define mode_Firewood_BITOFFSET                     3
#define mode_Firewood_LEN                           1
#define mode_Steamed_bag_BYTEOFFSET                    0
#define mode_Steamed_bag_BITOFFSET                     4
#define mode_Steamed_bag_LEN                           1

#define dianji_one_RATIO                         1
#define dianji_one_ADDITION                      0
#define dianji_one_MIN                           0
#define dianji_one_MAX                           180
#define set_the_time_RATIO                         1
#define set_the_time_ADDITION                      0
#define set_the_time_MIN                           0
#define set_the_time_MAX                           240
...
#define time_left_RATIO                         1
#define time_left_ADDITION                      0
#define time_left_MIN                           0
#define time_left_MAX                           14500
#define yanwu_RATIO                         1
#define yanwu_ADDITION                      0
#define yanwu_MIN                           0
#define yanwu_MAX                           1024
#define huoyan_RATIO                         1
#define huoyan_ADDITION                      0
#define huoyan_MIN                           0
#define huoyan_MAX                           1023
/**@} */
...
typedef enum
{
  ...
  EVENT_submit,
  EVENT_ignition,
  EVENT_mode_Slow_fire_old_soup,
  EVENT_mode_Firewood,
  EVENT_mode_Steamed_bag,
  EVENT_dianji_one,
  EVENT_set_the_time,
...
typedef struct {
  bool valuesubmit;
  bool valueignition;
  bool valuemode_Slow_fire_old_soup;
  bool valuemode_Firewood;
  bool valuemode_Steamed_bag;
  uint32_t valuedianji_one;
  uint32_t valueset_the_time;
  uint32_t valueTemperature;
  uint32_t valuehumidity;
  uint32_t valuetime_left;
  uint32_t valueyanwu;
  uint32_t valuehuoyan;
} dataPoint_t;


/** Corresponding to the protocol "4.10 WiFi module control device" in the flag " attr_flags" */ 
typedef struct {
  uint8_t flagsubmit:1;
  uint8_t flagignition:1;
  uint8_t flagmode_Slow_fire_old_soup:1;
  uint8_t flagmode_Firewood:1;
  uint8_t flagmode_Steamed_bag:1;
  uint8_t flagdianji_one:1;
  uint8_t flagset_the_time:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint8_t valuedianji_one;
  uint8_t valueset_the_time;
} attrVals_t;
...
typedef struct {
  ...
  uint16_t valuetime_left;
  uint16_t valueyanwu;
  uint16_t valuehuoyan;
} devStatus_t; 
